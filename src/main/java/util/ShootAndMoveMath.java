...
public class ShootAndMoveMath {
    ...
    public CorrectTime getTime(Vector3 d, Vector3 vr, double t, int iterations) {
    ...
    public CorrectTime getTime(Vector3 d, Vector3 vr) {
        return getTime(d, vr, Math.PI / 2, 0);
    }

    public double timeEquation(double t) {
    ...
    public double timeDerivative(double t) {
    ...
    public double dotProduct(Vector3 u, Vector3 v) {
